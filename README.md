...
I am a student currently studying for a Bachelor's of Computer Science. I like [Minecraft](https://www.minecraft.net/en-us) far too much and you will catch me on a few other video games. I currently work as a software developer!
...
[![Pea's Tech Stack](https://skillicons.dev/icons?i=aws,azure,bash,c,codepen,bots,cpp,cs,css,docker,dotnet,eclipse,gcp,git,github,gitlab,gradle,haskell,html,idea,java,js,linux,lua,md,maven,mongodb,nodejs,postgres,postman,powershell,python,react,regex,replit,spring,tensorflow,terraform,twitter,unity,vim,visualstudio,vscode,vue)](https://github.com/tandpfun/skill-icons)
<!--
